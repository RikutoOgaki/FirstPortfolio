...
export default function ProfileBlock() {
    return (
        <>
            <Box as='section'>
                <Flex flexDir={'column'} justifyContent={'flex-start'} marginLeft={'5%'} marginRight={'5%'} marginTop={'10rem'}>
                    ...
                    <Text as={'p'} color={'#fff'} fontSize={'1.8rem'}>ECCコンピューター専門学校 Webデザインコース</Text>
                    <Text as={'p'} color={'#fff'} fontSize={'1.8rem'}>25年卒</Text>
